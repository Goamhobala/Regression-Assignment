...
```
Scatter plot of continuous variables against each other
...
p1 <- ggplot(data_tidy_air_quality, aes(x = data_tidy_air_quality$industrial_activity, y = data_tidy_air_quality$particulate_matter)) +
  geom_boxplot() +
  labs(title = "Particulate Matter Levels by Industrial Activity",
       x = "Industrial Activity",
       y = "Particulate Matter Levels") +
  theme_minimal()

# Plot particulate matter against day of the week
p2 <- ggplot(data_tidy_air_quality, aes(x = data_tidy_air_quality$day_of_week, y = data_tidy_air_quality$particulate_matter)) +
  geom_boxplot() +
  labs(title = "Particulate Matter Levels by Day of the Week",
       x = "Day of the Week",
       y = "Particulate Matter Levels") +
  theme_minimal()

p3 <- ggplot(data_tidy_air_quality, aes(x =data_tidy_air_quality$holiday , y = data_tidy_air_quality$particulate_matter)) +
  geom_boxplot() +
  labs(title = "Particulate Matter Levels by Day of the Week",
       x = "Day of the Week",
       y = "Particulate Matter Levels") +
...
```
Plots of categorical variables against Particulate matter
...
p1 <- ggplot(data_tidy_air_quality, aes(x = data_tidy_air_quality$day_of_week, fill = data_tidy_air_quality$industrial_activity)) +
  geom_bar(position = "fill") + 
  labs(title = "Stacked Bar Chart of Industrial Activity and Days of the week ",
       x = "day of the Week",
       y = "Proportion Particulate Matter") +
  theme_minimal() +
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
p2 <- ggplot(data_tidy_air_quality, aes(x = data_tidy_air_quality$day_of_week, fill = data_tidy_air_quality$holiday)) +
  geom_bar(position = "fill") +  
  labs(title = "Stacked Bar Chart of day of the Week and holiday ",
       x = "Day of the Week",
       y = "Proportion Of Particulate Matter") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
p3 <- ggplot(data_tidy_air_quality, aes(x = data_tidy_air_quality$industrial_activity, fill = data_tidy_air_quality$holiday)) +
  geom_bar(position = "fill") +  
  labs(title = "Stacked Bar Chart of Industrial Activity and holiday ",
       x = "Industrial Activity",
       y = "Proportion of Particulate Matter") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
The average increase in particulate matter concentration caused by Traffic Density—that is, one additional vehicle per hour, while holding all other explanatory variables constant—is estimated to be 0.0799 $\mu g/m^3$ (95% CI: 0.0155, 0.1444), indicating a positive correlation.
