...
run_simulation <- function() {
  ...
  error_variances <- rnorm(n, 100, sqrt(50)) # Variance of each error term
  variance_gamma <- rgamma(n, shape=200, rate=2)
  e <- rnorm(n, mean = 0, error_variances)  # Simulated errors with heteroscedasticity
