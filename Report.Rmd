...
# Mosaic plot for industrial_activity and day_of_week
mosaic(~ data_tidy_air_quality$industrial_activity + data_tidy_air_quality$day_of_week, data = data_tidy_air_quality, main = "Mosaic Plot: Industrial Activity vs Day of Week")
mosaic(~ data_tidy_air_quality$industrial_activity + data_tidy_air_quality$holiday, data = data_tidy_air_quality, main = "Mosaic Plot: Industrial Activity vs Holiday")
```
...
```{r echo=FALSE}
mosaic(~ data_tidy_air_quality$day_of_week + data_tidy_air_quality$holiday, data = data_tidy_air_quality, main = "Mosaic Plot:Day of the Week vs Holiday")
```
